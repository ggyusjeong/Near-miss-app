...
with st.form("report_form"):
    location = st.selectbox("발견 위치", ["1층", "2층", "3층", "4층", "별관", "지상주차장", "지하주차장", "외곽", "기타"])
...
st.markdown(
    "<div style='background-color: #f8f9fa; padding: 15px; border-radius: 8px; border-left: 5px solid #ff4b4b; margin-top: 25px; margin-bottom: 20px;'>"
